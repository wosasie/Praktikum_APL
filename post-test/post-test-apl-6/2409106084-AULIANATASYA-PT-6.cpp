...
void bubbleSort_nama_merch(Merchandise katalog[], int panjang_array) {
    for (int i = 0; i < panjang_array - 1; i++) {
        for (int j = 0; j < panjang_array - i - 1; j++) {
            if (katalog[j].nama_merch < katalog[j + 1].nama_merch) {
...
void bubbleSort_harga_merch(Merchandise katalog[], int panjang_array) {
    for (int i = 0; i < panjang_array - 1; i++) {
        for (int j = 0; j < panjang_array - i - 1; j++) {
            if (katalog[j].rincian.harga_merch > katalog[j + 1].rincian.harga_merch) {
                swap(katalog[j], katalog[j + 1]);
            }
        }
    }
...
void bubbleSort_stok_merch(Merchandise katalog[], int panjang_array) {
    for (int i = 0; i < panjang_array - 1; i++) {
        for (int j = 0; j < panjang_array - i - 1; j++) {
            if (katalog[j].rincian.stok_merch > katalog[j + 1].rincian.stok_merch) {
                swap(katalog[j], katalog[j + 1]);
            }
        }
    }
...
void menu_sorting_merch(Merchandise Katalog[], int panjang_array) {
    ...
    cin >> pilih_sort_merch;
    cout << "----------------------------------------------" << endl;

    if (pilih_sort_merch == 1) {
        bubbleSort_nama_merch(katalog, panjang_array);
        cout << "================================================================================" << endl;
        cout << "                Berikut Sorting Merchandise Berdasarkan Nama (Z-A)              " << endl;
    } else if (pilih_sort_merch == 2) {
        bubbleSort_harga_merch(katalog, panjang_array);
        cout << "================================================================================" << endl;
        cout << "                  Berikut Sorting Merchandise Berdasarkan Harga                 " << endl;
    } else if (pilih_sort_merch == 3) {
        bubbleSort_stok_merch(katalog, panjang_array);
        cout << "================================================================================" << endl;
        cout << "                  Berikut Sorting Merchandise Berdasarkan Stok                  " << endl;
    } else { 
        cout << "Oopsie! Pilihan nomor sorting merchandise ga valid nih!" << endl;
        return;
    }
...
void menu_utama(Merchandise katalog[], int *panjang_array) {
    ...
    do {
        ...
        cout << "5. Sorting Merchandise" << endl;
        cout << "6. Logout" << endl;
        cout << "Masukan pilihan: ";
        ...
        switch (pilihan_menu_merch) {
            ...
            case 4:
                ...
                break;
            case 5:
                menu_sorting_merch(katalog, *panjang_array);
                break;
            case 6:
